...
- http://\<ip\>:\<port\>/add?tag=AMAZON%20FR&enable=0&dns=www.amazon.fr&period=4&priority=1
- http://\<ip\>:\<port\>/delete?tag=AMAZON%20FR
- http://\<ip\>:\<port\>/update?tag=AMAZON%20FR&enable=1&dns=www.amazon.fr&period=20&priority=1
